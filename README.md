...
> This pro ject is inspired by an awesome pinned-gist project.<br/>Find more in https://github.com/matchai/awesome-pinned-gists
...
1. Create a token with the `gis. t` and `repo` scope and copy it. (https://github.com/settings/tokens/new)
